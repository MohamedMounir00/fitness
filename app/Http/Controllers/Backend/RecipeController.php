    ...
    public function getAnyDate()
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '<a href="' . route('dites.edit', $data->id) . '" class="btn btn-round  btn-primary"><i class="fa fa-edit"></i></a>
          ...
          <button class="btn btn-delete btn btn-round  btn-danger" data-remote="delete_dites/' . $data->id . '"><i class="fa fa-remove"></i></button>
            ';
            })
