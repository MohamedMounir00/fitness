    ...
    public function getAnyDate()
    {
        ...
        return Datatables::of($data)
            ->addColumn('action', function ($data) {
                return '<a href="' . route('equipment.edit', $data->id) . '" class="btn btn-outline-primary">' . trans("backend.update") . '</a>
          ...
          <button class="btn btn-outline-danger" data-remote="delete_equipment/' . $data->id . '">' . trans("backend.delete") . '</button>
            ';
            })
