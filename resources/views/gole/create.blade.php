@extends('layouts.app')
@section('page_title' , trans('backend.goleCreate'))
...
<div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__body">
                ...
                {!! Form::open(['route'=>['goal.store'],'method'=>'POST','class'=>'form-horizontal form-label-left ','novalidate','files'=>true]) !!}
                ...
                <div class="row form-group">
                    ...
                    <br>
                    <div class="myButton">
                            <button id="send" type="submit" class="btn btn-primary btn-elevate btn-pill btn-sm">{{trans('backend.save')}}</button>
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>{{trans('backend.goleCreate')}}</h3>
                </div>
