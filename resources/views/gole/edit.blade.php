...
{{-- 
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h3>{{trans('backend.goleupdate')}}</h3>
                        ...
                        <div class="x_content">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="first-name" name="name_ar" required class="form-control col-md-7 col-xs-12" value="{{$goal->name_ar}}">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="first-name" name="name_en" required class="form-control col-md-7 col-xs-12" value="{{$goal->name_en}}">
                                </div>
                            </div>
                            <div class="item form-group">
