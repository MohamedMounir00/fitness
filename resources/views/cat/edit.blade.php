...
<div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__body">
                ...
                {!! Form::open(['route'=>['cat.update',$data->id],'method'=>'PUT','class'=>'form-horizontal form-label-left ','novalidate','files'=>true]) !!}
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="image view view-first">
                            @if(isset($data->imgeCat->url))
                                <img  style="width: 300px; display: block;"src="{{url($data->imgeCat->url)}}">
                            @endif
                        </div>
                ...
                <div class="myButton">
                        ...
                        <a href="{{route('cat.index')}}"  class="btn btn-info btn-elevate btn-pill btn-sm">{{trans('backend.back')}}</a>
                ...
                >
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    ...
                                    <a href="{{route('cat.index')}}"  class="btn btn-primary">{{trans('backend.back')}}</a>
