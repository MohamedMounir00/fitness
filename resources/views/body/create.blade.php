...
<div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__body">
                ...
                {!! Form::open(['route'=>['body.store'],'method'=>'POST','class'=>'form-horizontal form-label-left ','novalidate','files'=>true]) !!}
                ...
                <br>
                    ...
                    <div class="myButton">
                            ...
                            <a href="{{route('body.index')}}"  class="btn btn-primary btn-elevate btn-pill btn-sm">{{trans('backend.back')}}</a>
