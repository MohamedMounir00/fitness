...
<div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__body">
                ...
                {!! Form::open(['route'=>['body.update',$data->id],'method'=>'PUT','class'=>'form-horizontal form-label-left ','novalidate','files'=>true]) !!}
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="image view view-first">
                            @if(isset($data->imgebody->url))
                                <img  style="width: 300px; display: block;"src="{{url($data->imgebody->url)}}">
                            @endif
                        </div>
                ...
                <div class="myButton">
                        ...
                        <a href="{{route('body.index')}}"  class="btn btn-info btn-elevate btn-pill btn-sm">{{trans('backend.back')}}</a>
